...
dot -Tsvg $RESULTS_DIR/subgraph_name_val.gv > $RESULTS_DIR/subgraph_name_val.svg
...
dot -Tsvg $RESULTS_DIR/subgraph_date_val.gv > $RESULTS_DIR/subgraph_date_val.svg
