...
def clean_scientific_name():  
    ...
    input1_data_file_name='data/demo_input.csv'
    local_authority_source_file_name='data/demo_localDB.csv'
    output1_data_file_name='run/demo_output_name_val.csv'
    name_val_log_file_name='run/name_val_log.txt'
    record_id_file_name = 'run/record_id.txt'
    ...
    local_authority_source = csv.DictReader(open('data/demo_localDB.csv', 'r'),
                                delimiter=',')
    ...
    input1_data = csv.DictReader(open('data/demo_input.csv', 'r'),
                                delimiter=',')
    ...
    output1_data = csv.DictWriter(open('run/demo_output_name_val.csv', 'w'), 
...
def clean_event_date():
    ...
    input2_data_file_name='run/demo_output_name_val.csv'
    record_id_file_name = "run/record_id.txt"
    output2_data_file_name='run/demo_output_name_date_val.csv'
    date_val_log_file_name='run/date_val_log.txt'
    ...
    input2_data = csv.DictReader(open('run/demo_output_name_val.csv', 'r'),
                                delimiter=',')
    # iterate over input data records
    record2_num = 0
    RecordID_lst = []
    ...
    # open file for storing output data if not already open
    output2_data = csv.DictWriter(open('run/demo_output_name_date_val.csv', 'w'), 
